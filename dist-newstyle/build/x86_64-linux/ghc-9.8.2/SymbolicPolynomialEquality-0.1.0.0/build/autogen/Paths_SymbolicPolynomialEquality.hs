...
{-# OPTIONS_GHC -w #-}
module Paths_SymbolicPolynomialEquality (
    version,
...
getLibDir     = catchIO (getEnv "SymbolicPolynomialEquality_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "SymbolicPolynomialEquality_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "SymbolicPolynomialEquality_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "SymbolicPolynomialEquality_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "SymbolicPolynomialEquality_sysconfdir") (\_ -> return sysconfdir)
